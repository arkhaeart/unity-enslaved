...
namespace UnityEditor
{
    ...
    public class PrefabBrush : UnityEditor.Tilemaps.GridBrush
    {
        ...
        public override void Paint(GridLayout grid, GameObject brushTarget, Vector3Int position)
        {
            ...
            GameObject prefab = m_Prefabs[objIndex];
    ...
    public class PrefabBrushEditor : UnityEditor.Tilemaps.GridBrushEditor
    {
        ...
        public override void OnPaintInspectorGUI()
        {
            ...
            prefabBrush.objIndex = EditorGUILayout.IntField("Choose object", prefabBrush.objIndex);
            EditorGUILayout.LabelField("Current item: "+prefabBrush.m_Prefabs[prefabBrush.objIndex].name);
